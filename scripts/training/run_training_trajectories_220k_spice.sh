...
--n_threads 24 \
--db_path ../../data/D-traj-220k-SPICE.db \
--eval_db_path ../../data/D-test-SPICE.db \
...
--exp_name SPICE-traj-220k \
--full_checkpoint_freq  10000 \
--light_checkpoint_freq 50000 \
--save_checkpoints True \
--load_baseline ../../checkpoints/baseline-NNP-SPICE/NNP_checkpoint \
--log_dir ../../results \
--project_name GOLF-SPICE-baseline \
